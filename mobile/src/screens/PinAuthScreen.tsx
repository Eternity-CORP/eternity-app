...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 14, color: '#fff', fontWeight: '500', marginBottom: 16, textTransform: 'uppercase', letterSpacing: 1 },
  errorText: { color: '#FF3B30', marginBottom: 12, fontSize: 13 },
  lockoutText: { color: '#FF9500', marginBottom: 12, fontSize: 13 },
  input: {
    width: '100%',
    maxWidth: 320,
    height: 48,
  ...
  biometricButton: { marginTop: 8, paddingVertical: 12, paddingHorizontal: 20, borderRadius: 6, backgroundColor: '#333' },
  biometricButtonText: { color: '#fff', fontSize: 12, fontWeight: '500', textTransform: 'uppercase', letterSpacing: 0.5 },
  cancelButton: { marginTop: 12 },
  cancelText: { color: '#888', fontSize: 12, textTransform: 'uppercase', letterSpacing: 0.5 },
});
