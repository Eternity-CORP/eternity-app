...
**Epic Files (docs/prd/):**
- `epic-01-infrastructure.md` — Transfer infrastructure and API keys
- `epic-02-same-chain-transfer.md` — Same-chain ETH/ERC-20 transfers
- `epic-03-crosschain-execution.md` — Cross-chain transfer testing and routing validation
- `epic-04-mobile-security.md` — Biometric/PIN authentication and transaction security
- `epic-05-demo-live-mode.md` — Demo/Live mode toggle for testnet/mainnet
- `epic-06-ai-integration.md` — **NEW: Thinking Wallet AI features (Point A)** ⭐
