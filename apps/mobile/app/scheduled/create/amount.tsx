/**
 * Scheduled Payment Create - Step 3: Amount Input
 */
...
export default function ScheduledAmountScreen() {
  ...
  const [amount, setAmountLocal] = useState(scheduledCreate.amount || '');

  const selectedToken = balance.balances.find((t) => t.symbol === scheduledCreate.selectedToken);
  ...
  const handleContinue = () => {
    ...
    router.push('/scheduled/create/schedule');
  };
