...
const personalFeatures: ShowcaseFeature[] = [
  ...
  },
  {
    ...
    visual: 'phone',
    phoneScreen: { title: 'Contacts', content: '12 saved', details: ['Quick select', 'Address + username', 'Import suggestions'] },
  },
  {
    id: 'scheduled',
    category: 'personal',
    ...
    visual: 'phone',
    phoneScreen: { title: 'Scheduled', content: '3 active', details: ['Daily, weekly, monthly', 'Auto-execute', 'Notifications'] },
  },
  {
    id: 'ai',
    category: 'personal',
  ...
  },
  {
    ...
    visual: 'phone',
    phoneScreen: { title: 'Split Bill', content: '$45.00 / 3', details: ['Equal or custom', 'Track payments', 'Send reminders'] },
  },
]
